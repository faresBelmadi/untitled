...
namespace MoreMountains.TopDownEngine
{
	...
	public class CharacterPathfinder3D : CharacterAbility
	{
		...
		protected virtual void DeterminePath(Vector3 startingPosition, Vector3 targetPosition, bool ignoreDelay = false)
		{
			...
			if (NavMesh.SamplePosition(startingPosition, out _navMeshHit, ClosestPointThreshold, AreaMask))
			{
			...
			if (NavMesh.SamplePosition(targetPosition, out _navMeshHit, ClosestPointThreshold, AreaMask))
			{
